...
wl.Descriptions():new_productionsite_type {
    ...
    programs = {
        main = {
            ...
            actions = {
                "return=skipped when economy needs wine and not economy needs granite and not economy needs marble and not economy needs quartz and not economy needs diamond",
                "return=skipped when economy needs biscuit and not economy needs granite and not economy needs marble and not economy needs quartz and not economy needs diamond",
                "consume=biscuit",
                "call=mine_granite",
                "call=mine_marble",
                "call=mine_granite",
