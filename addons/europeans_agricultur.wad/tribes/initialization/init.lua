...
local init_europeans = {
    ...
    starting_conditions = {
        ...
        "addons/europeans_agricultur.wad/tribes/scripting/starting_conditions/harbors_ai.lua";
        "addons/europeans_agricultur.wad/tribes/scripting/starting_conditions/harbors_human.lua";
