...
init = {
   ...
   func = function(player, shared_in_start)
      ...
      place_building_in_region(player, "gauls_cattle_farm", sf:region(11), {
         inputs = { wheat = 8, water = 8, straw = 8}
      })
      place_building_in_region(player, "gauls_workshop", sf:region(8), {
         inputs = { iron = 6, log = 6, planks = 4, reed = 6 }
      })
      place_building_in_region(player, "gauls_sawmill", sf:region(10), {
         inputs = { log = 8 }
      })
