...
wl.Descriptions():new_tribe {
   ...
   fastplace = {
      ...
      military_fortress = "gauls_castle",
      woodcutter = "gauls_woodcutters_house",
      forester = "gauls_foresters_house",
      quarry = "gauls_stonecutters_hut",
      building_materials_primary = "gauls_sawmill",
      building_materials_secondary = "gauls_clay_pit",
      building_materials_tertiary = "gauls_reed_yard",
      hunter = "gauls_hunters_hut",
      fisher = "gauls_fishers_hut",
      well = "gauls_well",
      farm_primary = "gauls_farm",
      farm_secondary = "gauls_garden",
      mill = "gauls_mill",
      bakery = "gauls_bakery",
      brewery = "gauls_druids_house",
      smokery = "gauls_smokery",
      ...
      second_carrier = "gauls_cattle_farm",
      charcoal = "gauls_charcoal_kiln",
      mine_stone = "gauls_tin_mine",
      mine_coal = "gauls_coal_mine_small",
      mine_iron = "gauls_iron_mine_small",
      mine_gold = "gauls_copper_mine",
      agriculture_producer = "gauls_orchard",
      agriculture_consumer_primary = "gauls_threshing_floor",
      agriculture_consumer_secondary  = "gauls_sheep_farm",
      industry_alternative = "gauls_sewing_workshop",
      industry_supporter = "gauls_brick_kiln",
   },
}
