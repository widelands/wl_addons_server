...
wl.Descriptions():new_militarysite_type {
   ...
   enhancement = {
    ...
    messages = {
        ...
        -- TRANSLATORS: Message sent by a Gauls military site
        aggressor = pgettext("gauls_building", "Your casle discovered an aggressor."),
        -- TRANSLATORS: Message sent by a Gauls military site
        attack = pgettext("gauls_building", "Your castle is under attack."),
        -- TRANSLATORS: Message sent by a Gauls military site
        defeated_enemy = pgettext("gauls_building", "The enemy defeated your warriors at the casle."),
        -- TRANSLATORS: Message sent by a Gauls military site
        defeated_you = pgettext("gauls_building", "Your warriors defeated the enemy at the casle.")
    },
}
