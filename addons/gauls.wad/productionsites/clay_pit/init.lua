...
wl.Descriptions():new_productionsite_type {
   ...
   descname = pgettext ("gauls_building", "Clay Pit"),
   ...
   out_of_resource_notification = {
      ...
      message = pgettext ("gauls_building", "The clay digger working at this clay pit can’t find any level ground in his work area. Consider dismantling this clay pit and rebuilding it somewhere else."),
