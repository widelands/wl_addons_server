   ...
   wares_order = {
      ...
      },
      {
         ...
         },
         {
            ...
            preciousness = 1,
            helptexts = {
                -- TRANSLATORS: Helptext for an Empire ware: Steel Shield
                purpose = pgettext("empire_ware", "This steel shield is produced in the armor smithy and used in the arena – together with food – to train soldiers from defense level 0 to level 1.")
            }
         },
         {
            ...
            preciousness = 1,
            helptexts = {
                -- TRANSLATORS: Helptext for an Empire ware: Advanced Shield
                purpose = pgettext("empire_ware", "These advanced shields are used by the best soldiers of the Atlanteans. They are produced in the armor smithy and used in the colosseum – together with food – to train soldiers from defense level 1 to level 2.")
            }
         },
         {
            name = "armor_helmet",
