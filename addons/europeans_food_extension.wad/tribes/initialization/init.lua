...
local init_europeans = {
    ...
    descname = _"Europeans (Food Extension)",
    tooltip = _"This is the culture of the Europeans.",
    icon = dirname .. "images/icon.png",
    script = dirname .. "units.lua",

    starting_conditions = {
        "addons/europeans_food_extension.wad/tribes/scripting/starting_conditions/headquarters_human.lua";
        "addons/europeans_food_extension.wad/tribes/scripting/starting_conditions/harbors_human.lua";
        "addons/europeans_food_extension.wad/tribes/scripting/starting_conditions/discovery_human.lua";
    }
}
pop_textdomain()
