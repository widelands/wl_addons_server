...
dirname = "tribes/buildings/productionsites/empire/coalmine/"
    ...
    programs = {
        main = {
            ...
            actions = {
                ...
                "return=skipped when economy needs snack and not economy needs granite and not economy needs diamond and not economy needs coal",
