...
init = {
   ...
   place_building_in_region(plr, "europeans_smithy_level_1", sf:region(6), {
   ...
   place_building_in_region(plr, "europeans_farm_level_1", sf:region(16), {
   })
   place_building_in_region(plr, "europeans_well_normal", sf:region(16), {
   })
   place_building_in_region(plr, "europeans_well_normal", sf:region(16), {
   })
