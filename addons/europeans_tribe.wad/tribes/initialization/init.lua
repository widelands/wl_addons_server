...
local init_europeans = {
    ...
    starting_conditions = {
        "addons/europeans_tribe.wad/tribes/scripting/starting_conditions/headquarters_ai.lua";
        "addons/europeans_tribe.wad/tribes/scripting/starting_conditions/headquarters_human.lua";
        "addons/europeans_tribe.wad/tribes/scripting/starting_conditions/harbors_ai.lua";
        "addons/europeans_tribe.wad/tribes/scripting/starting_conditions/harbors_human.lua";
        "addons/europeans_tribe.wad/tribes/scripting/starting_conditions/discovery_ai.lua";
