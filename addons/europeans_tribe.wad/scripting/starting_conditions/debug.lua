...
local init = {
    ...
    for i = 0, 1023 do
        ...
        elseif i == 24 then
            player:allow_buildings{"europeans_clay_pit_basic", "europeans_terraformers_house_basic", }
        end
        -- Normal Buildings
        if i == 25 then
        ...
        elseif i == 48 then
            player:allow_buildings{"europeans_warehouse", "europeans_clay_pit_normal", "europeans_terraformers_house_normal", }
        end
        -- Advanced Buildings
        if i == 49 then
        ...
        elseif i == 72 then
            player:allow_buildings{"europeans_headquarters", "europeans_clay_pit_advanced", "europeans_terraformers_house_advanced", }
        end
