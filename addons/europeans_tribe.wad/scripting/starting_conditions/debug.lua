...
local init = {
    ...
    for i = 0, 1000 do
        ...
        if i == 3 then
            player:allow_buildings{"europeans_well_basic", "europeans_farm_medium_basic", }
        end
        if i == 4 then
            player:allow_buildings{"europeans_well_level_1", "europeans_foresters_house_basic", }
        end
        if i == 5 then
        ...
        if i == 13 then
            player:allow_buildings{"europeans_well_level_3", "europeans_foresters_house_normal", }
        end
        if i == 14 then
        ...
        if i == 22 then
            player:allow_buildings{"europeans_well_level_5", "europeans_foresters_house_advanced", }
        end
        if i == 23 then
        ...
        if ((map.allows_seafaring == true) and (map.number_of_port_spaces > 0)) and (i == 28) then
        ...
        if ((map.allows_seafaring == true) and (map.number_of_port_spaces > 0)) and (i == 64) then
            place_ship_random(player, 64)
        end
