...
local init = {
    ...
    player:forbid_buildings{"europeans_toolsmithy_normal", "europeans_armorsmithy_normal", "europeans_trainingscamp_level_3", "europeans_trainingscamp_level_2", "europeans_trainingscamp_level_1", "europeans_battlearena_level_2", "europeans_battlearena_level_1"}    
