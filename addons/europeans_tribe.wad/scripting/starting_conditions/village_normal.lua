...
init = {
    ...
    place_building_in_region(player, "europeans_warehouse_normal", sf:region(2), {
        wares = {
            log = 127,
            reed = 127,
            coal = 63,
    ...
    --for i = 1, 17520 do
        ...
        --if i >= 12 then
            ---- enhance or dismantle productionssites automatically, which productivity is lower than 25 %
            --change_idle_stopped_buildings(player, 25)
        --end
    --end
end
}
