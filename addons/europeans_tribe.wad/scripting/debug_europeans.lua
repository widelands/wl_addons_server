...
function allow_normal_buildings(player_number)
    ...
    if tribe.name == "europeans" then
        player:allow_buildings{"europeans_well_level_2", "europeans_well_level_3", "europeans_lumberjacks_house_normal", "europeans_foresters_house_normal", "europeans_quarry_normal", "europeans_clay_pit_normal"}
        player:allow_buildings{"europeans_sawmill_normal", "europeans_charcoal_kiln_normal", "europeans_stonemasons_house_normal", "europeans_weaving_mill_normal"}
        player:allow_buildings{"europeans_farm_normal", "europeans_animal_farm_normal", "europeans_mill_normal", "europeans_bakery_normal", "europeans_brewery_normal"}
...
function forbid_normal_buildings(player_number)
    ...
    if tribe.name == "europeans" then
        player:forbid_buildings{"europeans_well_level_2","europeans_well_level_3", "europeans_lumberjacks_house_normal", "europeans_foresters_house_normal", "europeans_quarry_normal", "europeans_clay_pit_normal"}
        player:forbid_buildings{"europeans_sawmill_normal", "europeans_charcoal_kiln_normal", "europeans_stonemasons_house_normal", "europeans_weaving_mill_normal"}
        player:forbid_buildings{"europeans_farm_normal", "europeans_animal_farm_normal", "europeans_mill_normal", "europeans_bakery_normal", "europeans_brewery_normal"}
...
function allow_advanced_buildings(player_number)
    ...
    if tribe.name == "europeans" then
        player:allow_buildings{"europeans_well_level_4", "europeans_well_level_5", "europeans_lumberjacks_house_advanced", "europeans_foresters_house_advanced", "europeans_quarry_advanced", "europeans_clay_pit_advanced"}
        player:allow_buildings{"europeans_sawmill_advanced", "europeans_charcoal_kiln_advanced", "europeans_stonemasons_house_advanced", "europeans_weaving_mill_advanced"}
        player:allow_buildings{"europeans_farm_advanced", "europeans_animal_farm_advanced", "europeans_mill_advanced", "europeans_bakery_advanced", "europeans_brewery_advanced"}
...
function forbid_advanced_buildings(player_number)
    ...
    if tribe.name == "europeans" then
        player:forbid_buildings{"europeans_well_level_4", "europeans_well_level_5", "europeans_lumberjacks_house_advanced", "europeans_foresters_house_advanced", "europeans_quarry_advanced", "europeans_clay_pit_advanced"}
        player:forbid_buildings{"europeans_sawmill_advanced", "europeans_charcoal_kiln_advanced", "europeans_stonemasons_house_advanced", "europeans_weaving_mill_advanced"}
        player:forbid_buildings{"europeans_farm_advanced", "europeans_animal_farm_advanced", "europeans_mill_advanced", "europeans_bakery_advanced", "europeans_brewery_advanced"}
