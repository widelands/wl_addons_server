...
function allow_normal_buildings(player_number)
    ...
    if tribe.name == "europeans" then
        ...
        player:allow_buildings{"europeans_sawmill_normal", "europeans_charcoal_kiln_normal", "europeans_stonemasons_house_normal"}
        player:allow_buildings{"europeans_farm_medium_normal", "europeans_weaving_mill_normal"}
...
function forbid_normal_buildings(player_number)
    ...
    if tribe.name == "europeans" then
        ...
        player:forbid_buildings{"europeans_sawmill_normal", "europeans_charcoal_kiln_normal", "europeans_stonemasons_house_normal"}
        player:forbid_buildings{"europeans_farm_medium_normal", "europeans_weaving_mill_normal"}
...
function allow_advanced_buildings(player_number)
    ...
    if tribe.name == "europeans" then
        ...
        player:allow_buildings{"europeans_sawmill_advanced", "europeans_charcoal_kiln_advanced", "europeans_stonemasons_house_advanced"}
        player:allow_buildings{"europeans_farm_medium_advanced", "europeans_weaving_mill_advanced"}
...
function forbid_advanced_buildings(player_number)
    ...
    if tribe.name == "europeans" then
        ...
        player:forbid_buildings{"europeans_sawmill_advanced", "europeans_charcoal_kiln_advanced", "europeans_stonemasons_house_advanced"}
        player:forbid_buildings{"europeans_farm_medium_advanced", "europeans_weaving_mill_advanced"}
