...
dirname = "tribes/buildings/productionsites/empire/marblemine_deep/"

wl.Descriptions():new_productionsite_type {
    name = "europeans_food_stonemine_level_2",
    -- TRANSLATORS: This is a building name used in lists of buildings
    descname = pgettext("europeans_building", "Stone Mine Level 2"),
    ...
    programs = {
        main = {
            ...
            actions = {
                ...
                "return=skipped when economy needs snack and not economy needs granite and not economy needs marble and not economy needs quartz and not economy needs diamond",
