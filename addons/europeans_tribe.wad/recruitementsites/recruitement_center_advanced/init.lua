...
descriptions:new_productionsite_type {
   ...
   inputs = {
      { name = "europeans_carrier", amount = 8 },
      { name = "basket", amount = 8 },
      { name = "buckets", amount = 4 },
      { name = "shovel", amount = 4 },
      { name = "saw", amount = 4 },
      { name = "hammer", amount = 4 },
      { name = "pick", amount = 4 },
      { name = "felling_ax", amount = 4 },
      { name = "fire_tongs", amount = 4 },
      { name = "scythe", amount = 4 },
      { name = "milking_tongs", amount = 4 },
      { name = "needles", amount = 4 },
      { name = "fishing_rod", amount = 4 },
      { name = "fishing_net", amount = 4 },
      { name = "hunting_bow", amount = 4 },
      { name = "hunting_spear", amount = 4 },
      { name = "bread_paddle", amount = 4 },
      { name = "hook_pole", amount = 4 },
   ...
   programs = {
      ...
      recruit_fishbreeder = {
         ...
         actions = {
            "return=skipped unless economy needs europeans_fishbreeder_advanced",
            "sleep=duration:10s",
            "consume=buckets shovel europeans_carrier",
            "animate=working duration:15s",
            "recruit=europeans_fishbreeder_advanced"
         }
      },
      recruit_gamekeeper = {
         -- TRANSLATORS: Completed/Skipped/Did not start recruiting worker because ...
         ...
         actions = {
            "return=skipped unless economy needs europeans_gamekeeper_advanced",
            "sleep=duration:10s",
            "consume=basket europeans_carrier",
            "animate=working duration:15s",
            "recruit=europeans_gamekeeper_advanced"
         }
      },
      recruit_beekeeper = {
         -- TRANSLATORS: Completed/Skipped/Did not start recruiting worker because ...
