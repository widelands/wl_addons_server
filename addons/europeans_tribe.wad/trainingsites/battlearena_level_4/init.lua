...
descriptions:new_trainingsite_type {
   ...
   ["soldier defense"] = {
      ...
      weapons = {"helmet_mask", "shield_steel", "helmet_golden", "shield_advanced", "helmet_warhelm"}
   },
   ...
   ["soldier attack"] = {
      ...
      weapons = {"spear_advanced", "ax_broad", "trident_steel", "sword_broad", "trident_heavy_double"}
   },
   ...
   ["soldier health"] = {
      ...
      weapons = {"tabard", "armor_chain", "armor_helmet", "armor_gilded", "tabard_golden"}
   },
   ...
   programs = {
      ...
      upgrade_soldier_defense_2 = {
         ...
         actions = {
            ...
            "consume=snack mead helmet_golden",
      ...
      upgrade_soldier_defense_4 = {
         ...
         actions = {
            ...
            "consume=meal wine helmet_warhelm",
