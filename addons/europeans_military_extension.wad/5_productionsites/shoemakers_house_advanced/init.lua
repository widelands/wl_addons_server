    ...
    programs = {
        ...
        produce_boots_swift = {
            ...
            actions = {
                ...
                "return=skipped when economy needs balsa and not economy needs boots_swift",
        ...
        produce_boots_advanced = {
            ...
            actions = {
                ...
                "return=skipped when economy needs balsa and not economy needs boots_advanced",
