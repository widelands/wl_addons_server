...
wl.Descriptions():new_tribe {
    ...
    collectors_points_table = {
        { ware = "granite", points = 1 },
        { ware = "marble", points = 2 },
        { ware = "quartz", points = 4 },
        { ware = "diamond", points = 8 },
        { ware = "marble_column", points = 8 },
    },
    ...
    resource_indicators = {
        ...
        resource_coal = {
            [10] = "europeans_resi_none",
            [20] = "europeans_resi_none",
        },
        resource_iron = {
            [10] = "europeans_resi_none",
            [20] = "europeans_resi_none",
    ...
    immovables = {
        ...
        },
        {
            ...
            helptexts = {
                -- TRANSLATORS: Helptext for a Europeans immovable: Pond
                purpose = _("When quarry dig up earth, they leave holes with water in the ground. These falls dry after a while or can be used by terraformer to produce new soil.")
            }
        },
        {
            name = "reedfield_tiny",
   ...
   UNUSED_soldier_3 = npgettext("europeans_soldier", "%1%(+%2%) soldier", "%1%(+%2%) soldiers", 0),
    ...
    port = "europeans_port",
    scouts_house = "europeans_lumberjacks_house_basic",
    ship = "europeans_ship",
    ...
    fastplace = {
        ...
        military_medium_secondary = "europeans_castle",
