   ...
   func = function(player, shared_in_start)
      ...
      if #warehouses > 0 then
         ...
         if wh:get_wares("granite") < 100 then
            wh:set_wares("granite", wh:get_wares("granite") + 30)
            added = added + 1
         end
         if wh:get_wares("coal") < 100 then
            wh:set_wares("coal", wh:get_wares("coal") + 20)
            added = added + 1
         end
         if wh:get_wares("ironwood") < 50 then
            wh:set_wares("ironwood", wh:get_wares("ironwood") + 20)
            added = added + 1
         end
         if wh:get_wares("rubber") < 50 then
            wh:set_wares("rubber", wh:get_wares("rubber") + 20)
            added = added + 1
         end
         if wh:get_wares("liana") < 100 then
            wh:set_wares("liana", wh:get_wares("liana") + 40)
            added = added + 1
         end
         if wh:get_wares("fish") < 70 then
            wh:set_wares("fish", wh:get_wares("fish") + 20)
            added = added + 1
         end
         ...
         if player:get_wares("cassavaroot") < 60 then
            wh:set_wares("cassavaroot", wh:get_wares("cassavaroot") + 20)
            added = added + 1
         end
