-- =======================================================================
--           Trading Outpost starting conditions for Lutas’ Atlanteans
-- =======================================================================
...
init = {
   ...
   func = function(player, shared_in_start)
      ...
      place_building_in_region(player, "lutas_atlanteans_toolsmithy", sf:region(11), {
         inputs = {
            iron = 6,
            log = 6,
            spider_silk = 4
      ...
      place_building_in_region(player, "lutas_atlanteans_sawmill", sf:region(11), {
         inputs = {
            log = 8
         }
      })

      place_building_in_region(player, "lutas_atlanteans_hunters_house", sf:region(11), {
         inputs = {}
      })
