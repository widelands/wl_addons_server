...
wl.Descriptions():new_trainingsite_type {
   ...
   descname = pgettext("lutas_atlanteans_building", "Labyrinth"),
   ...
   programs = {
      ...
      upgrade_soldier_defense_0 = {
         ...
         descname = pgettext("lutas_atlanteans_building", "upgrading soldier defense from level 0 to level 1"),
         actions = {
      ...
      upgrade_soldier_defense_1 = {
         -- TRANSLATORS: Completed/Skipped/Did not start upgrading ... because ...
         descname = pgettext("lutas_atlanteans_building", "upgrading soldier defense from level 1 to level 2"),
         actions = {
      ...
      upgrade_soldier_evade_0 = {
         -- TRANSLATORS: Completed/Skipped/Did not start upgrading ... because ...
         descname = pgettext("lutas_atlanteans_building", "upgrading soldier evade from level 0 to level 1"),
         actions = {
      ...
      upgrade_soldier_evade_1 = {
         -- TRANSLATORS: Completed/Skipped/Did not start upgrading ... because ...
         descname = pgettext("lutas_atlanteans_building", "upgrading soldier evade from level 1 to level 2"),
         actions = {
