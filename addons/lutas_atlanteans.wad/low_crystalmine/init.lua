...
wl.Descriptions():new_productionsite_type {
   name = "atlanteans_low_crystalmine",
   -- TRANSLATORS: This is a building name used in lists of buildings
   descname = pgettext("atlanteans_building", "Low Crystal Mine"),
   ...
   programs = {
      ...
      a_mine_produce_granite = {
         ...
         actions = {
            ...
            "mine=resource_stones radius:4 yield:35% when_empty:5%",
            "produce=granite",
         }
      },
   ...
   out_of_resource_notification = {
      ...
      message =
         pgettext("atlanteans_building", "This crystal mine’s main vein is exhausted. Expect strongly diminished returns on investment. You should consider enhancing, dismantling or destroying it."),
   },
}
