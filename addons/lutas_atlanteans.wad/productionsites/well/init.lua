...
wl.Descriptions():new_productionsite_type {
   ...
   descname = pgettext("lutas_atlanteans_building", "Well"),
   ...
   out_of_resource_notification = {
      ...
      message = pgettext("lutas_atlanteans_building", "The carrier working at this well can’t find any water in his well."),
