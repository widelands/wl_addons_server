...
wl.Descriptions():new_trainingsite_type {
   name = "atlanteans_temple",
   -- TRANSLATORS: This is a building name used in lists of buildings
   descname = pgettext("atlanteans_building", "Temple"),
   ...
   programs = {
      ...
      upgrade_soldier_health_0 = {
         ...
         actions = {
            ...
            "consume=smoked_fish,smoked_meat,atlanteans_bread tabard",
            "train=soldier:health level:1"
         }
      },
      upgrade_soldier_health_1 = {
         -- TRANSLATORS: Completed/Skipped/Did not start upgrading ... because ...
         descname = pgettext("atlantean_building", "upgrading soldier health from level 1 to level 2"),
         actions = {
            ...
            "callworker=attract_shells",
            "checksoldier=soldier:health level:1",
            "consume=smoked_fish,smoked_meat,atlanteans_bread:2 tabard_golden",
   ...
   messages = {
      ...
      no_soldier = pgettext("atlantean_building", "No soldier to train!"),
      -- TRANSLATORS: Atlantean training site tooltip when none of the present soldier match the current training program
      no_soldier_for_level = pgettext("atlantean_building", "No soldier found for this training level!"),
   },
}
