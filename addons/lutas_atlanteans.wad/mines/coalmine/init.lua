...
wl.Descriptions():new_productionsite_type {
   ...
   descname = pgettext("lutas_atlanteans_building", "Coal Mine"),
   ...
   out_of_resource_notification = {
      ...
      message =
         pgettext("lutas_atlanteans_building", "This coal mine’s main vein is exhausted. Expect strongly diminished returns on investment. You should consider dismantling or destroying it."),
   },
}
