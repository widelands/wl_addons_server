...
wl.Descriptions():new_productionsite_type {
   ...
   descname = pgettext("lutas_atlanteans_building", "Low Crystal Mine"),
   ...
   programs = {
      ...
      a_mine_produce_granite = {
         ...
         actions = {
            ...
            "mine=resource_stones radius:3 yield:35% when_empty:5%",
            "produce=granite",
         }
      },
   ...
   out_of_resource_notification = {
      ...
      message =
         pgettext("lutas_atlanteans_building", "This crystal mine’s main vein is exhausted. Expect strongly diminished returns on investment. You should consider enhancing, dismantling or destroying it."),
   },
}
