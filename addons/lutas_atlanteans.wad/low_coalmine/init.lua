...
wl.Descriptions():new_productionsite_type {
   name = "atlanteans_low_coalmine",
   -- TRANSLATORS: This is a building name used in lists of buildings
   descname = pgettext("atlanteans_building", "Low Coal Mine"),
   ...
   programs = {
      ...
      mine_produce = {
         ...
         actions = {
            ...
            "mine=resource_coal radius:4 yield:35% when_empty:5%",
            "produce=coal",
         }
      },
      encyclopedia = {
   ...
   out_of_resource_notification = {
      ...
      message =
         pgettext("atlanteans_building", "This coal mine’s main vein is exhausted. Expect strongly diminished returns on investment. You should consider enhancing, dismantling or destroying it."),
   },
}
