...
function reset_player_warehouse_policy(player)
    ...
    for i, ware in ipairs(tribe.wares) do
        for k, building in ipairs(player:get_buildings("sumatran_headquarters")) do
            building:set_warehouse_policies(ware.name, "normal")
        end
        for k, building in ipairs(player:get_buildings("sumatran_warehouse")) do
            building:set_warehouse_policies(ware.name, "normal")
        end
        for k, building in ipairs(player:get_buildings("sumatran_port")) do
            building:set_warehouse_policies(ware.name, "normal")
        end
    end
    for i, worker in ipairs(tribe.workers) do
...
function set_hero_advanced_militarysites(player)
    local ms3 = player:get_buildings("sumatran_sentry_big")
    local mt3 = player:get_buildings("sumatran_fortified_tower")
    local mf3 = player:get_buildings("sumatran_fortification")
