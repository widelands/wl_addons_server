...
function allow_normal_buildings(player_number)
    ...
    if tribe.name == "sumatrans" then
        ...
        player:allow_buildings{"sumatran_stonecutters_hut", "sumatran_water_carriers_hut", "sumatran_leaf_gatherers_hut" }
...
function forbid_normal_buildings(player_number)
    ...
    if tribe.name == "sumatrans" then
        ...
        player:forbid_buildings{"sumatran_stonecutters_hut", "sumatran_water_carriers_hut", "sumatran_leaf_gatherers_hut" }
