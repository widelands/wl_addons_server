...
wl.Descriptions():new_militarysite_type {
   ...
   messages = {
      ...
      occupied = pgettext("sumatran_building", "Your warriors have occupied your fortified tower."),
      -- TRANSLATORS: Message sent by a Sumatran military site
      ...
      -- TRANSLATORS: Message sent by a Sumatran military site
      defeated_enemy = pgettext("sumatran_building", "The enemy defeated your warriors at the fortified tower."),
      -- TRANSLATORS: Message sent by a Sumatran military site
      defeated_you = pgettext("sumatran_building", "Your warriors defeated the enemy at the fortified tower.")
   },
}
