...
wl.Descriptions():modify_unit("terrain", "winter_tundra", "enhancement", "amazons", "summer_steppe")
...
wl.Descriptions():modify_unit("terrain", "drysoil", "enhancement", "amazons", "summer_steppe")
