...
local dirname = "tribes/buildings/productionsites/frisians/goldmine/"

wl.Descriptions():new_productionsite_type {
    name = "europeans_goldmine_level_6",
    -- TRANSLATORS: This is a building name used in lists of buildings
    descname = pgettext("europeans_building", "Gold Mine Level 6"),
    ...
    programs = {
        ...
        mine_marble = {
            ...
            actions = {
                ...
                "mine=resource_gold radius:5 yield:80% when_empty:14% experience_on_fail:20%",
                "produce=marble",
            }
        },
        mine_ore = {
