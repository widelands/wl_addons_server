...
local dirname = "tribes/buildings/productionsites/amazons/cassava_plantation/"

wl.Descriptions():new_productionsite_type {
    name = "europeans_cassava_farm",
    -- TRANSLATORS: This is a building name used in lists of buildings
    descname = pgettext ("europeans_building", "Cassava Plantation"),
    ...
    out_of_resource_notification = {
        ...
        message = pgettext ("europeans_building", "The farmer working at this cassava plantation has no cleared soil to plant her seeds."),
