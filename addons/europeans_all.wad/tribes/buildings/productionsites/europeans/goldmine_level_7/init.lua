...
local dirname = "tribes/buildings/productionsites/frisians/goldmine_deep/"

wl.Descriptions():new_productionsite_type {
    name = "europeans_goldmine_level_7",
    -- TRANSLATORS: This is a building name used in lists of buildings
    descname = pgettext("europeans_building", "Gold Mine Level 7"),
    ...
    programs = {
        ...
        mine_marble = {
            ...
            actions = {
                ...
                "mine=resource_gold radius:5 yield:100% when_empty:20% experience_on_fail:25%",
                "produce=marble",
            }
        },
        mine_ore = {
            ...
            actions = {
                "animate=working duration:30s",
                "mine=resource_gold radius:5 yield:100% when_empty:16% experience_on_fail:25%",
