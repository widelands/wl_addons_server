...
local dirname = "tribes/buildings/productionsites/frisians/rockmine_deep/"

wl.Descriptions():new_productionsite_type {
    name = "europeans_stonemine_level_6",
    -- TRANSLATORS: This is a building name used in lists of buildings
    descname = pgettext("europeans_building", "Stone Mine Level 6"),
    ...
    programs = {
        ...
        mine_granite = {
            ...
            actions = {
                ...
                "mine=resource_stones radius:5 yield:100% when_empty:50% experience_on_fail:25%",
                "produce=granite",
            }
        },
        mine_marble = {
            ...
            actions = {
                "animate=working duration:35s",
                "mine=resource_stones radius:5 yield:100% when_empty:25% experience_on_fail:25%",
                "produce=marble",
            }
        },
        mine_diamond = {
            ...
            actions = {
                "animate=working duration:35s",
                "mine=resource_stones radius:5 yield:100% when_empty:15% experience_on_fail:25%",
                "produce=diamond",
            }
        },
        mine_quartz = {
