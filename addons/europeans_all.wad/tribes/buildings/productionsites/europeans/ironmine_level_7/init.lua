...
local dirname = "tribes/buildings/productionsites/frisians/ironmine_deep/"

wl.Descriptions():new_productionsite_type {
    name = "europeans_ironmine_level_7",
    -- TRANSLATORS: This is a building name used in lists of buildings
    descname = pgettext("europeans_building", "Iron Mine Level 7"),
    ...
    programs = {
        ...
        mine_marble = {
            ...
            actions = {
                ...
                "mine=resource_iron radius:5 yield:100% when_empty:20% experience_on_fail:25%",
                "produce=marble",
            }
        },
        mine_ore = {
            ...
            actions = {
                "animate=working duration:30s",
                "mine=resource_iron radius:5 yield:100% when_empty:16% experience_on_fail:25%",
