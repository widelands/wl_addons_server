...
wl.Descriptions():new_trainingsite_type {
    ...
    inputs = {
        { name = "meat", amount = 6 },
        { name = "fish", amount = 6 },
        { name = "atlanteans_bread", amount = 8 },
    ...
    programs = {
        ...
        upgrade_soldier_evade_0 = {
            ...
            actions = {
                ...
                "consume=boots_sturdy atlanteans_bread fish,meat chocolate",
        ...
        upgrade_soldier_evade_1 = {
            ...
            actions = {
                ...
                "consume=boots_swift atlanteans_bread fish,meat chocolate",
        ...
        upgrade_soldier_defense_0 = {
            ...
            actions = {
                ...
                "consume=shield_steel,helmet,helmet_mask atlanteans_bread fish,meat chocolate",
