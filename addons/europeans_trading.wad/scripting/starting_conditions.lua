...
function doing_ai_stuff(player, increment)
    ...
    if (increment == 6) then
        player:allow_buildings{"europeans_castle", "europeans_market_small", "europeans_scouts_house_basic", "europeans_sawmill_normal", "europeans_weaving_mill_normal", }
    end
    if (increment == 8) then
        player:allow_buildings{"europeans_market_big", "europeans_trainingscamp_basic", "europeans_battlearena_basic", }
        ...
        if ((map.allows_seafaring == true) and (map.number_of_port_spaces > 0)) then
            ...
            player:allow_buildings{"europeans_warehouse", }
        end
    end
    if (increment == 16) then
        player:allow_buildings{"europeans_lumberjacks_house_normal", "europeans_quarry_normal", }
        player:allow_buildings{"europeans_farm_small_normal", "europeans_tree_nursery_normal", }
    ...
    if (increment == 24) then
        ...
        player:allow_buildings{"europeans_farm_small_advanced", "europeans_tree_nursery_advanced", }
