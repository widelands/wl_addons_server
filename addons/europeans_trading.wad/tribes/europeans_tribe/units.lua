...
wl.Descriptions():new_tribe {
    ...
    buildings = {
        ...
        {
            name = "europeans_market_reed",
            helptexts = {
                -- TRANSLATORS: Purpose helptext for an Europeans warehouse: Small Market
                purpose = pgettext("europeans_building", "Market building to sale reed for coins.")
            }
        },
        {
            ...
            helptexts = {
                -- TRANSLATORS: Purpose helptext for an Europeans warehouse: Small Market
                purpose = pgettext("europeans_building", "Market building to sale cotton for coins.")
            }
        },
        {
            name = "europeans_market_log",
            helptexts = {
                -- TRANSLATORS: Purpose helptext for an Europeans warehouse: Small Market
                purpose = pgettext("europeans_building", "Market building to sale log for coins.")
            }
        },
        {
            name = "europeans_market_rubber",
            helptexts = {
        ...
        },
        {
            ...
            helptexts = {
                -- TRANSLATORS: Purpose helptext for an Europeans warehouse: Big Market
                purpose = pgettext("europeans_building", "Market building to sale log, blackwood or planks for coins.")
            }
        },
        {
            ...
            helptexts = {
                -- TRANSLATORS: Purpose helptext for an Europeans warehouse: Big Market
                purpose = pgettext("europeans_building", "Market building to sale cloth or armor for coins.")
            }
        },
        {
