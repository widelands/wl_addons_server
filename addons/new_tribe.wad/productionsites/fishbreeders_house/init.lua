...
descriptions:new_productionsite_type {
   ...
   descname = pgettext("newtribe_building", "Fish Breeder’s House"),
   ...
   out_of_resource_notification = {
      ...
      message = pgettext("newtribe_building", "The fish breeder working out of this fish breeder’s house can’t find any fish in his work area. Remember that you can only regenerate your fish resources if there are some fish left to breed."),
