...
-------------- | ----------------------------------------------------------| -------------------------------------------------- | -------
`txissues`     | `id`                                                      | `varchar`                                          |
`addons`       | `id` <br> `name` <br> `timestamp` <br> `i18n_version` <br> `security` <br> `quality` <br> `downloads` | `int` <br> `varchar` <br> `bigint` <br> `int` <br> `tinyint` <br> `int` <br> `int` | Unique add-on ID<br>-<br>-<br>-<br>-<br>-<br>-
