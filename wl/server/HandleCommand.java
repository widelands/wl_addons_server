...
abstract class HandleCommand {
	public static void handleCmdList(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		// Args: –
	...
	public static void handleCmdInfo(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		// Args: name
	...
	public static void handleCmdDownload(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		// Args: name
		ServerUtils.checkNrArgs(cmd, 1);
		ServerUtils.checkNameValid(cmd[1], false);
		ServerUtils.checkAddOnExists(cmd[1]);
	...
	public static void handleCmdI18n(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		// Args: name
		ServerUtils.checkNrArgs(cmd, 1);
		ServerUtils.checkNameValid(cmd[1], false);
		ServerUtils.checkAddOnExists(cmd[1]);
	...
	public static void handleCmdScreenshot(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		// Args: addon screenie
	...
	public static void handleCmdVote(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		// Args: name vote
		ServerUtils.checkNrArgs(cmd, 2);
	...
	public static void handleCmdGetVote(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		// Args: name
		ServerUtils.checkNrArgs(cmd, 1);
		if (username.isEmpty()) {
	...
	public static void handleCmdComment(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		...
		if (!ServerUtils.readLine(in).equals("ENDOFSTREAM")) throw new ProtocolException("Stream continues past its end");
		Utils.comment(cmd[1], username, cmd[2], msg);
		out.println("ENDOFSTREAM");
	}

	public static void handleCmdEditComment(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
	...
	public static void handleCmdContact(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		// Args: lines
		ServerUtils.checkNrArgs(cmd, 1);
	...
	public static void handleCmdSubmitScreenshot(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
	...
	public static void handleCmdSubmit(String[] cmd, PrintStream out, InputStream in, int version, String username, boolean admin, String locale) throws Exception {
		// Args: name
		ServerUtils.checkNrArgs(cmd, 1);
